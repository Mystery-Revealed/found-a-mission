...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'found-a-mission', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[found-a-mission] listening on :${config.port} — sessions live in memory only`);
});
